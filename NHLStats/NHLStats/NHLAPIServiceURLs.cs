...
namespace NHLStats
{
    public static class NHLAPIServiceURLs
    {
        ...
        public static string leagueStandings = "https://api-web.nhle.com/v1/standings/";  // NEW API:  Append the date of the standing in YYYY-MM-DD format or "now" for the latest standings to the end of this string 
        //------------------------------------
        ...
        public static string teams = "https://api.nhle.com/stats/rest/en/team";  // NEW API:  Gets a list of teams 
